...
<h3 id="exportfunctiontrimendstringstring-chars"><code>export function trimEnd *(string(string, [chars])*</code></h3>

TrimEnd trims any whitespace or the selected characters from the end of the string

#### Arguments
1. `string` *(string)*: input string
2. `[chars]` *(string): characters to remove from end of the string &#42;(default ' ')*&#42;
