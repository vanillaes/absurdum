...
test('objects.at(object, paths) - returns an array containing selected property values from paths described by array of strings or undefined if it doesnt exist', t => {
